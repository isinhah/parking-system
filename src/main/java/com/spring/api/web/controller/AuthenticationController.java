...
import com.spring.api.jwt.JwtToken;
import com.spring.api.jwt.JwtUserDetailsService;
import com.spring.api.web.dto.UserLoginDto;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> authenticate(@RequestBody @Valid UserLoginDto dto, HttpServletRequest request) {
        log.info("Authentication by login: {}", dto.getUsername());
        try {
